...
import building from "../../assets/hstl_002/main-building.jpg";

const places = [
  { icon: MapPinned, name: "Janaki Mandir", time: "10 min walk" },
  { icon: BookOpen, name: "OM Coaching Centre", time: "10 min walk" },
  { icon: University, name: "REC College", time: "5 min walk" },
  { icon: School, name: "Ramanand Chowk", time: "5 min" },
  { icon: Cross, name: "Provincial Hospital", time: "10 min" },
];
        ...
        <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-10 items-center">
          ...
          >
            <button
              ...
              aria-label="Open full Aaryan Boys Hostel building photo"
            >
              <motion.img
                layoutId="nearby-main-building"
                src={building}
                alt="Aaryan Boys Hostel building near student essentials"
          ...
          >
            ...
            <p className="mt-4 text-lg text-slate-600">
              ...
              including Janaki Mandir, OM Coaching Centre, Ramanand Chowk, REC
              College, and Provincial Hospital.
            </p>
      ...
      <AnimatePresence>
        {isBuildingOpen && (
          <motion.div
            ...
            role="dialog"
            aria-modal="true"
            aria-label="Aaryan Boys Hostel full building photo"
          >
            <motion.div
            ...
            >
              <motion.img
                layoutId="nearby-main-building"
                src={building}
                alt="Aaryan Boys Hostel full building"
