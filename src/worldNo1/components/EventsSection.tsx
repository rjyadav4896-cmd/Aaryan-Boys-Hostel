...
import mainBuildingSideViewImage from "../../assets/hstl_002/main-building-side-view.jpeg";
import messImage from "../../assets/hstl_002/mess.jpg";
import parkingImage from "../../assets/hstl_002/parking.jpg";
import roomTwoImage from "../../assets/hstl_002/room-2sharing.jpg";
import roomThreeImage from "../../assets/hstl_002/room-3sharing.jpg";
import roomFourImage from "../../assets/hstl_002/room-4sharing.jpg";
import bathroomImage from "../../assets/hstl_002/bathroom.jpg";
import studentImage from "../../assets/hstl_002/student-life.jpg";
import studentBirthdayGroupImage from "../../assets/hstl_002/student-birthday-group.jpeg";
import studentBirthdayCelebrationImage from "../../assets/hstl_002/student-birthday-celebration.jpeg";
...
const studentLifePhotos = [
  { title: "Student Birthday Group", image: studentBirthdayGroupImage },
  { title: "Student Birthday Celebration", image: studentBirthdayCelebrationImage },
  { title: "Student Life", image: studentImage },
];

const propertyPhotos = [
  {
    title: "Main Building Side View",
    image: mainBuildingSideViewImage,
    showTitle: true,
  },
  ...
  { title: "Four Sharing Room", image: roomFourImage, showTitle: true },
...
const galleries = {
  festival: {
    ...
    description:
      "Festival meals and Dashain-Tihar moments together.",
    cover: studentBirthdayCelebrationImage,
    accent: "from-blue-500/70 via-sky-400/35 to-blue-950/90",
    icon: PartyPopper,
    photos: [
      { title: "Student Celebration", image: studentBirthdayCelebrationImage },
    ].filter(Boolean),
  },
  student: {
    title: "Student Images",
    description: "Daily community, room life, and shared hostel routines.",
    cover: studentBirthdayGroupImage,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-3 text-base leading-7 text-slate-600 sm:text-lg">
            Aaryan Boys Hostel keeps students supported during ordinary weeks
