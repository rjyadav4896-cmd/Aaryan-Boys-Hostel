      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <button onClick={() => scrollToSection('home')} className="flex min-w-0 flex-shrink-0 items-center">
            ...
            <span className="ml-2 truncate text-base font-black text-blue-950 sm:text-xl">Aaryan Boys Hostel</span>
          </button>
          ...
          <a href="tel:+9779809672987" className="hidden md:inline-flex rounded-lg bg-blue-950 px-4 py-2 text-sm font-bold text-white hover:bg-blue-900 transition-colors">
            Call Now
          </a>
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white border-t">
          <div className="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="tel:+9779809672987" className="block mx-3 mt-2 rounded-lg bg-blue-950 px-4 py-2 text-center font-bold text-white">
              Call Now
            </a>
          </div>
        </div>
